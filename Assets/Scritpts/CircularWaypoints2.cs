...
public class CircularWaypoints2 : MonoBehaviour, IWaypointProvider
{
    ...
    private string[] waypointNames = { "Punto_D", "Punto_C", "Punto_B", "Punto_A", "Punto_B",
                                       "Punto_J", "Punto_K", "Punto_J", "Punto_C", "Punto_H",
                                       "Punto_I", "Punto_H", "Punto_E", "Punto_F", "Punto_G",
                                       "Punto_F", "Punto_E", "Punto_D" };
