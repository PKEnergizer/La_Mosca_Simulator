...
public class CircularWaypoints3 : MonoBehaviour, IWaypointProvider
{
    ...
    private string[] waypointNames = { "Punto_I", "Punto_H", "Punto_C", "Punto_J", "Punto_K",
                                       "Punto_J", "Punto_B", "Punto_A", "Punto_B", "Punto_C",
                                       "Punto_D", "Punto_E", "Punto_F", "Punto_G", "Punto_F",
                                       "Punto_E", "Punto_H", "Punto_I" };
